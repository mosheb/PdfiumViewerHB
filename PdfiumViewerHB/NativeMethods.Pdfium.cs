...
using static PdfiumViewerHB.PdfFile;
...
namespace PdfiumViewerHB
{
    partial class NativeMethods
    {
        ...
        private static readonly string LockObj = "PdfiumViewerHB1";
        ...
        public static void FPDFPage_SetMediaBox(IntPtr page, float left, float bottom, float right, float top)
        {
            lock (LockObj)
                Imports.FPDFPage_SetMediaBox(page, left, bottom, right, top);
        }


        public static bool FPDFPage_GetMediaBox(IntPtr page, out float left, out float bottom, out float right, out float top)
        {
            lock (LockObj)
                return (uint)Imports.FPDFPage_GetMediaBox(page, out left, out bottom, out right, out top) > 0U;
        }
        ...
        private static class Imports
        {
            ...
            public static extern int FPDFPage_GetMediaBox(IntPtr page, [MarshalAs(UnmanagedType.R4)] out float left, [MarshalAs(UnmanagedType.R4)] out float bottom, [MarshalAs(UnmanagedType.R4)] out float right, [MarshalAs(UnmanagedType.R4)] out float top);

            [DllImport("pdfium.dll")]
            public static extern void FPDFPage_SetMediaBox(IntPtr page, [MarshalAs(UnmanagedType.R4)] float left, [MarshalAs(UnmanagedType.R4)] float bottom, [MarshalAs(UnmanagedType.R4)] float right, [MarshalAs(UnmanagedType.R4)] float top);
